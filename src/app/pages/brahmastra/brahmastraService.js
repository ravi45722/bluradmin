	...
	.factory('brahmastraFactory', function ($http, $q, $window, $timeout){
		console.log("Initial Data analysis Factory loaded");
			return {
				...
				getJobDetails: function(data){
					var deferred = $q.defer();
					setTimeout(function() {
						$http({
							method: 'POST',
							url: 'http://104.197.216.247:8000/initialdataanalysis/getJobDetails',
							//url: 'http://localhost:3010/fpanalysis/rulestats',
							headers: {
								accept: 'application/json'
							},
				...
				getUrlDetails: function(data) {
					var deferred = $q.defer();
					setTimeout(function() {
						$http({
							method: 'POST',
							url: 'http://104.197.216.247:8000/initialdataanalysis/getUrlDetails',
							//url: 'http://localhost:3010/fpanalysis/rulestats',
							headers: {
								accept: 'application/json'
							},
